...
class WC_Bot(discord.Client):
    ...
    async def post_next(self, channel):
        ...
        msg = await channel.send(
            content=f"<:exclamation:1462501395679805640> @everyone - **{round_name}** is now LIVE - Cast your votes below!", 
...
async def startworldcup(interaction: discord.Interaction):
    ...
    msg = await interaction.channel.send(
        content="<:exclamation:1462501395679805640> @everyone - **Round of 32** is now LIVE - Cast your votes below", 
        embed=view.create_embed(0), 
        view=view
    )

...
GITHUB_TOKEN = os.getenv("WC_TOKEN")  # keep as you have it
...
DEFAULT_DATA = {
    ...
    # item authors + 1-per-user rule
    "item_authors": {},      # item -> user_id (str)
    "user_items": {},        # user_id -> item

    # persistent history
    "cup_history": []        # list[{title,winner,author_id,timestamp}]
}
...
# =========================================================
# COMMANDS (ONLY CHANGE: defer + followup to stop Unknown interaction)
# =========================================================
